...
public class JwtFilter  extends OncePerRequestFilter {
    ...
    public JwtFilter( JwtUtil inyectUtil, UserDetailsService inyectUser){
        this.jwtUtil = inyectUtil;
        this.userDetailsService = inyectUser;
    }
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        String path = request.getServletPath();
            if("/auth/login".equals(path) || "/auth/register".equals(path) || "/cliente/index".equals(path)){
        ...
        if(authHeader != null && authHeader.startsWith("Bearer ")){
            ...
            if (!token.isBlank()){ //validar q no este vacio
              try{
